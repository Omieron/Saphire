...
const translations = {
    en: {
        ...
        dashboard: {
            ...
            subtitle: 'Manage your tasks and machine controls',
            activeTasks: 'My Active Tasks',
            noActiveTasks: 'You have no assigned tasks at the moment.',
            allMachines: 'Browse Machines',
        ...
        qcEntry: {
            ...
            exit: 'Exit',
            submit: 'Submit',
            timeWarning: 'Task Time Expired!',
            gracePeriod: 'Grace Period',
            graceMessage: 'You have 10 extra minutes to finish.',
            timeEnded: 'Time Ended',
            timeEndedMessage: 'The task time has ended. You can no longer continue.',
        },
        history: {
    ...
    tr: {
        ...
        dashboard: {
            ...
            subtitle: 'Görevlerinizi ve makine kontrollerini yönetin',
            activeTasks: 'Aktif Görevlerim',
            noActiveTasks: 'Şu an atanmış bir göreviniz bulunmuyor.',
            allMachines: 'Makinelere Göz At',
        ...
        qcEntry: {
            ...
            exit: 'Çık',
            submit: 'Gönder',
            timeWarning: 'Task Süresi Doldu!',
            gracePeriod: 'Ek Süre',
            graceMessage: 'Bitirmek için 10 dakika ek süreniz var.',
            timeEnded: 'Süre Bitti',
            timeEndedMessage: 'Görevin süresi doldu, devam edemezsiniz.',
        },
        history: {
            title: 'Gönderimlerim',
